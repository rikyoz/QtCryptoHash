 ...
 *   * Changed old C includes (i.e. <stdio.h>) to C++ equivalent (i.e. <cstdio>)
 *   * Now Rmd160 class implements the HashAlgorithm interface
 *   * Removed "rmd160_" prefix in methods name
 ...
 */
void Rmd160::write( const byte* inbuf, int inlen ) {
